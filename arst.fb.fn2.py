...
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
		print("\r\x1b[1;93mMR ARST█████████████████▒▒▒▒▒▒▒▒..99% \x1b[1;93m"+o),;sys.stdout.flush();time.sleep(0.1)
...
def login1():
	...
	try:
		...
		os.system('clear')
                time.sleep(0.05)
		print logo                
		print "\033[1;98m•-----------------\033[1;98mARST\033[1;98m-----------------•"
		...
		if 'save-device' in url:
			try:
				...
				unikers.close()
				print '\033[1;47m\033[1;94mATST Login Successful\033[1;0m'
				os.system('xdg-open https://www.youtube.com/channel/UCd-xhGAkBU4_0000CIqwxTjw')
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print "\033[1;98m•-----------------\033[1;34mARST TEAM \033[1;98m-----------------•"
		print logo
		jalan('\033[1;91m[+]\033[1;98mARST TEAM█████████████████▒▒▒▒▒▒▒▒..99%')
		...
		os.system('clear')
		print "\033[1;98m•-----------------\033[1;35mARST TEAM\033[1;98m-----------------•"
		print logo
		...
		try:
			...
			super()
		print"\033[1;98m[+]\033[1;94mARST█████████████████▒▒▒▒▒▒▒▒..100"
	...
	p.map(main, id)
#Dev:MR-SH4DOW-ALONE
        print "\033[1;98m•-----------------\033[1;38mARST\033[1;98m-----------------•"
...
"""
	print "\033[1;95m«-----------------\033[1;35m✅ARST✅\033[1;95m-----------------»"
